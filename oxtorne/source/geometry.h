...
typedef struct line3d   { vector3d p; vector3d q;                       } line3d;
typedef struct ray3d    { vector3d origin; vector3d direction;          } ray3d;
typedef struct plane3d  { vector3d normal; double scalar;               } plane3d;
...
ray3d       OX_make_ray3d       (const double, const double, const double, const double, const double, const double);
